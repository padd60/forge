...
Every rule is registered and typechecked in v0.1; their bodies are empty until their owning module lands. This lets `@forge/core` and `@forge/cli` reference the rules from their default configs without breaking the workspace build.
